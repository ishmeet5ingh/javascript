...
function createUser(username, email, password){
    // SetUsername(username) // calling but while execution context remove from the callstack variables vanish // only reference
    SetUsername.call(this, username)// using call to hold the reference//don't use SetUsername()'s 'this' createUser is giving its own 'this' so use this 'this' 
